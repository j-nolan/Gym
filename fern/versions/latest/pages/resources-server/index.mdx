...
<Card title="Example Resources Servers" href="/resources-server/example-resources-servers">
Compare built-in resources server examples for workplace tool use and math with code.
</Card>
